...
public class HashSet<E> extends AbstractSet<E> {
	...
	/** Hash Map object used for implementing HashSet. */
    private Map<E, E> map;
     ...
     * @param isTesting Boolean value for if we are testing the HashSet, if true then the random values used
     * for hashing will be set as constant.
     */
