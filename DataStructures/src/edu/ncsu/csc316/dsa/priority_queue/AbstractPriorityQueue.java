...
public abstract class AbstractPriorityQueue<K extends Comparable<K>, V> implements PriorityQueue<K, V> {
	...
	/** The comparator used for this PriorityQueue. */
    ...
    public class NaturalOrder implements Comparator<K> {
    	/**
    	 * Compares two key objects using their natural ordering.
    	 ...
    	 * or a negative number if the second is greater than the first
    	 */
    ...
    public static class PQEntry<K, V> implements Entry<K, V> {
    	...
    	/** The key value for this PQEntry. */
        private K key;
        /** The value held by this PQEntry. */
        private V value;
     ...
     * @return a newly created PQEntry using the given key and value
     */
