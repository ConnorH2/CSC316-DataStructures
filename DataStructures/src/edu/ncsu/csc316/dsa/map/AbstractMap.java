...
public abstract class AbstractMap<K, V> implements Map<K, V> {
    ...
    protected static class MapEntry<K, V> implements Entry<K, V> {
    	...
    	/** The key data value for the map entry */
        private K key;
        /** The value stored in the map entry */
        private V value;
    ...
    protected class EntryCollection implements Iterable<Entry<K, V>> {
    	...
    	/** The internal List object used for EntryCollection implementation. */
        ...
        private class EntryCollectionIterator implements Iterator<Entry<K, V>> {
        	...
        	/** The Iterator object for use in the EntryCollectionIterator. */
    ...
    protected class KeyIterator implements Iterator<K> {
    	...
    	/** The Iterator object for use in the KeyIterator. */
        private Iterator<Entry<K, V>> it;
    ...
    protected class ValueIterator implements Iterator<V> {
    	...
    	/** The Iterator object for use in the ValueIterator. */
    	private Iterator<Entry<K, V>> it;
