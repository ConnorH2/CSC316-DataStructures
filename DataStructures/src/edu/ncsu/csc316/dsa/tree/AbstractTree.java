...
public abstract class AbstractTree<E> implements Tree<E> {
    ...
    public E set(Position<E> p, E value) {
        ...
        AbstractTreeNode<E> p2 = validate(p);
        p2.setElement(value);
        return replaced;
    }   
    ...
    protected abstract static class AbstractTreeNode<E> implements Position<E> {
    	...
    	/** The element which this tree node contains. */
        private E element;
    ...
    protected class PositionCollection implements Iterable<Position<E>> {
    	...
    	/** The list containing positions which can be iterated through. */
         ...
         * @return A new iterator for the PositionCollection.
         */
        ...
        private class PositionSetIterator implements Iterator<Position<E>> {
        	...
        	/** The iterator object for use in PositionSetIterator, */
