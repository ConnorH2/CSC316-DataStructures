...
public abstract class AbstractGraph<V, E> implements Graph<V, E> {
    ...
    protected class GraphVertex implements Vertex<V> {
    	/** The element this vertex contains. */
        private V element;
        /** The position of this vertex in the graph. */
    ...
    protected class GraphEdge implements Edge<E> {
    	/** The element that this edge contains. */
        private E element;
        /** The vertexes that this edge connects. */
        private Vertex<V>[] endpoints;
        /** The position of this edge in the graph. */
