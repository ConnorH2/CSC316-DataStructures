...
public class StudentReaderTest {
	...
	/**
	 * Tests the readFile method in StudentReaderTest.
	 */
	@Test
	public void testReadFile() {
		StudentReader s = new StudentReader();
		assertTrue(s instanceof StudentReader);
		
		Student[] contents = StudentReader.readInputAsArray("input/student_ascendingID.csv");
		assertThrows(IllegalArgumentException.class, () -> StudentReader.readInputAsArray("input/abc.csv"));
		...
		assertEquals(3, (int) contents[6].getGpa());
