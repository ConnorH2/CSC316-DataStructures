...
public class QuickSorterTest {
	...
	/** QuickSorter object for testing */
	private QuickSorter<Integer> integerSorter;

	/**
	 * Setup function for QuickSorterTest.
	 */
	@Before
	public void setUp() {
	...
	/**
	 * Tests QuickSorter using integers.
	 */
	@Test
	public void testSortIntegers() {
		...
		Integer[] dataRandom2 = { 4, 1, 5, 3, 2 };
		Integer[] dataRandom3 = { 4, 1, 5, 3, 2 };
		QuickSorter<Integer> integerSorter2 = new QuickSorter<Integer>(QuickSorter.FIRST_ELEMENT_SELECTOR);
		QuickSorter<Integer> integerSorter3 = new QuickSorter<Integer>(QuickSorter.LAST_ELEMENT_SELECTOR);
		
		integerSorter2.sort(dataRandom2);
		assertEquals(Integer.valueOf(1), dataRandom2[0]);
		assertEquals(Integer.valueOf(2), dataRandom2[1]);
		assertEquals(Integer.valueOf(3), dataRandom2[2]);
		assertEquals(Integer.valueOf(4), dataRandom2[3]);
		assertEquals(Integer.valueOf(5), dataRandom2[4]);
		
		integerSorter3.sort(dataRandom3);
		assertEquals(Integer.valueOf(1), dataRandom3[0]);
		assertEquals(Integer.valueOf(2), dataRandom3[1]);
		assertEquals(Integer.valueOf(3), dataRandom3[2]);
		assertEquals(Integer.valueOf(4), dataRandom3[3]);
		assertEquals(Integer.valueOf(5), dataRandom3[4]);
	}

	/**
	 * Tests QuickSorter using students.
	 */
	@Test
	public void testSortStudent() {
		...
		QuickSorter<Student> studentSorter = new QuickSorter<Student>(QuickSorter.MIDDLE_ELEMENT_SELECTOR);
		...
		QuickSorter<Student> studentSorter2 = new QuickSorter<Student>(comparator2);
