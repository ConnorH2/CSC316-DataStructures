...
public class SelectionSorterTest {
	...
	/** SelectionSorter object for testing */
	private SelectionSorter<Integer> integerSorter;

	/**
	 * Setup function for SelectionSorterTest.
	 */
	@Before
	public void setUp() {
	...
	/**
	 * Tests SelectionSorter using integers.
	 */
	@Test
	...
	/**
	 * Tests SelectionSorter using students.
	 */
	@Test
	public void testSortStudent() {
		...
		SelectionSorter<Student> studentSorter = new SelectionSorter<Student>();
		...
		SelectionSorter<Student> studentSorter2 = new SelectionSorter<Student>(comparator2);
