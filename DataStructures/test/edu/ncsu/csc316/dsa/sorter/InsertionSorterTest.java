...
public class InsertionSorterTest {
	...
	/** InsertionSorter object for testing */
	private InsertionSorter<Integer> integerSorter;

	/**
	 * Setup function for InsertionSorterTest.
	 */
	@Before
	public void setUp() {
	...
	/**
	 * Tests InsertionSorter using integers.
	 */
	@Test
	...
	/**
	 * Tests InsertionSorter using students.
	 */
	@Test
	public void testSortStudent() {
		...
		InsertionSorter<Student> studentSorter2 = new InsertionSorter<Student>(comparator2);
