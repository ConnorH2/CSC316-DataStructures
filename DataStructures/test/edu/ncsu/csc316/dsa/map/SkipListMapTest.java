...
public class SkipListMapTest {
	...
	/** Map object for testing SkipListMap using basic data types. */
    private Map<Integer, String> map;
    /** Map object for testing SkipListMap using students. */
    ...
    public void testStudentMap() {
        ...
        assertEquals("SkipListMap[]", studentMap.toString());
